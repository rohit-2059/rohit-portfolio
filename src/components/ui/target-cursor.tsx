...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  const cornersArr: HTMLDivElement[] = [tlc, trc, brc, blc];
  const offsets: { x: number; y: number }[] = [tlOffset, trOffset, brOffset, blOffset];
  ...
  window.addEventListener('mouseover', enterHandler as unknown as EventListener, { passive: true } as AddEventListenerOptions);
